...
import { Image, View, StyleSheet,  Dimensions, TouchableOpacity, Text, Pressable, Platform } from "react-native";
...
(
    <View style={styles.container}>
  {
    photos_path.map((image, index) => ( 
      ...
      <TouchableOpacity key={index} onPress={()=> navigation.navigate("GalleryImage", { name: image })}>
